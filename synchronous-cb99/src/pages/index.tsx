  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to APEX - A Telemedicine web application that allows patients to schedule virtual appointments
          with healthcare providers, conduct video consultations, and securely store medical records."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMGNvbmZlcmVuY2luZ3xlbnwwfHx8fDE2OTU1MjgwODF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Apex - A Telemedicine web application that allows patients to schedule virtual appointments
          with healthcare providers, conduct video consultations, and securely store medical records.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Doctor" type="administrator" abilities={appConfig.ownerAbilities} />

                <Card userTypeName="Patient" type="guest" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
