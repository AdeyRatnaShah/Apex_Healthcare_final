...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'Doctor', 'guest-user', 'manager', 'Patient'];
    ...
    >
      ...
      <Flex flexDirection="column" h="full" overflowY="auto">
        ...
        <Box mt="auto" px={8} pb={4}>
            <Link href="https://alok-2004.github.io/" style={{ textDecoration: 'none' }}>
              <Button
                mb={2}
                ...
                borderRadius="100px"
                size="sm"
                rightIcon={<ReservationIcon color="secondary.content" width="17px" height="17px" />}
                boxShadow={`
